...
abstract class Currency implements Built<Currency, CurrencyBuilder> {
  ...
  static Currency fromJson(dynamic val) {
    return serializers.deserialize(val, specifiedType: FullType(Currency));
  }

  String toJson() {
    return json
        .encode(serializers.serialize(this, specifiedType: FullType(Currency)));
  }

  static Serializer<Currency> get serializer => _$currencySerializer;

  static Currency lookup(String symbol) {
    final String name = currencies[symbol];
